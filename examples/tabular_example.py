...
def train_catboost(dataset, exp, **kwargs):
    ...
    fit_kwargs = dict(cat_features=np.arange(dataset.x_train_cat.shape[1]), early_stopping_rounds=100)
...
if __name__ == '__main__':
    ...
    #                    tensorboard=True, stop_at=0.98, parallel=1, device=2, n_quantiles=6, catboost=True,
    #                    rulenet=False)
