...
class K8SConfig(BeamConfig):
    ...
    parameters = [
        ...
        BeamParam('kopf_username: "your-username"', str, None, 'Kopf username'),
        BeamParam('kopf_password: "your-password"', str, None, 'Kopf password'),
        BeamParam('kopf_server: "https://your-kopf-server.com"', str, None, 'Kopf server'),
        BeamParam('enable_ray_ports', bool, False, 'Enable Ray ports'),
